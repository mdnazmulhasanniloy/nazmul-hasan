...
// Validate ../../app/api/admin/content/[section]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/content/[section]">> = Specific
  const handler = {} as typeof import("../../app/api/admin/content/[section]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
